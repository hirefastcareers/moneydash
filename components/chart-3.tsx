            ...
            <CardHeader className="max-md:px-4">
                ...
                <div className="mt-4 flex items-center gap-6">
                    <div className="space-y-1.5">
                        ...
                        <p className="text-lg leading-none font-semibold sm:text-2xl">$12,345</p>
                    </div>
                    <div className="bg-border h-10 w-px"></div>
                    <div className="space-y-1.5">
                        <p className="text-muted-foreground text-sm font-medium whitespace-nowrap">Avg. Order</p>
                        <p className="text-lg leading-none font-semibold sm:text-2xl">$248</p>
                    </div>
                    ...
                    <div className="space-y-1.5 max-sm:hidden">
                        ...
                        <p className="text-lg leading-none font-semibold sm:text-2xl">+7.2%</p>
                    </div>
                </div>
            </CardHeader>
